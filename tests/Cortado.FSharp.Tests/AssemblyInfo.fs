...
[<assembly: AssemblyTitleAttribute("Cortado.FSharp.Tests")>]
[<assembly: AssemblyProductAttribute("Cortado.FSharp")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Cortado.FSharp.Tests"
    let [<Literal>] AssemblyProduct = "Cortado.FSharp"
